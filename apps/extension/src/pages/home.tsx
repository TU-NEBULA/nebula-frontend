  ...
  return (
    <main className="h-full gap-80 flex flex-col justify-center">
      <section className="space-y-4">
        ...
        <p className=" text-gray5">크롬 익스텐션 실행을 위해 로그인 해주세요.</p>
      </section>
      <section className="space-y-7">
        ...
        <div className="text-description gap-3 flex items-center justify-center text-gray3">
          <button>이용약관</button>
          <div className="h-3 w-px bg-gray3" />
