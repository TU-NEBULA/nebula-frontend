  ...
  return (
    <div className="space-y-2">
      <div className="space-y-1">
        <h2 className="text-text text-gray6">키워드</h2>
        <div className="border border-gray5 p-2 rounded-sm flex justify-between gap-2 items-center text-text min-h-keyword">
      ...
      <ul className="list-disc px-3.5 text-gray7 text-text">
